...
#saveRDS(ROSmaster,file="/Users/dfelsky/Documents/monocyte_twas/integrated_analyses_v4/TWAS/Jan2021/ROSmaster_TWAS_input.rds")
...
indepvec.cognition <- names(newdatsub2)[-c(1,9)] #names(newdatsub)[-1] #c("cogn_global_random_slope","cogn_ep_random_slope","cogn_po_random_slope","cogn_ps_random_slope","cogn_se_random_slope","cogn_wo_random_slope")
